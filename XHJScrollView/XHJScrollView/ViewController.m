...
- (void)viewDidLoad {
    [super viewDidLoad];
    // 初始化rollView并设置属性
    self.myView = [[MyScrollView alloc] initWithFrame:(CGRectMake(0, 0, kScreenWidth, kScreenHeight))];
    ...
    // 这里我们直接用本地图片进行模拟
    self.myView.dataArr = @[@"0.jpg", @"1.jpg", @"2.jpg", @"3.jpg", @"5.jpg", @"6.jpg", @"7.jpg", @"8.jpg", @"9.jpg", @"10.jpg"];
    
    // 这里修改样式,type是一个枚举类型
    self.myView.type = iCarouselTypeRotary;
